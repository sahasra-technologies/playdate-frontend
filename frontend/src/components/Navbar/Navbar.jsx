      ...
      <div className="nav-buttons desktop-only">
        ...
        {isLoggedIn ? (
          ...
          <button onClick={handleLoginClick} className="btn">
            <FaUser className="btn-icon" /> {isLoggedIn ? (names?.name || 'Profile') : 'Login'}
          </button>
        )}
      </div>
